...
export default function Page1() {
    ...
    const handleMouseDown = (e) => {
      ...
      console.log("On mouse down","Mouse Event:", e.clientX,e.clientY,"CurrnetPosition:",position.x,position.y)
      setIsDragging(true);
      setInitialPosition({ 
    ...
    const handleMouseMove =(e:MouseEvent) => {
      ...
      console.log("Changed Position",e.clientX,e.clientY,"Inital Position",initailPosition.x,initailPosition.y)
