...
export default function page() {
  ...
  return (
    <div className="flex flex-col"><div className="flex justify-center items-center mt-[50px] gap-20 ">
...
<div className="text-lg text-center font-light mt-5">Trusted at companies large and small</div>
        </div>
  )
}
