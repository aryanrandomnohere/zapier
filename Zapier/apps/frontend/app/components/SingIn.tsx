...
export default function SingIn() {
  ...
  return (
    <div className="max-w-[450px]  border border-black/10 p-6">
    <div className="flex flex-col gap-4 max-w-[390px]"> <div className="flex items-center min-w-[390px] p-2 bg-blue-500/90 rounded hover:bg-blue-600 transition-all duration-500 cursor-pointer w-60 text-center justify-between">
