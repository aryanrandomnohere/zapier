...
export const getZaps = async (req: extendedRequest, res: Response) => {
...
export const createDraft = async (req: extendedRequest, res: Response) => {
  try {
...
export const getZapHistory = async (req: extendedRequest, res: Response) => {
  try {
...
export const updateTrigger = async (req: extendedRequest, res: Response) => {
  try {
...
export const updateAction = async (req: extendedRequest, res: Response) => {
  try {
    const zapId = Number(req.params.zapId);
...
export const dublicateZap = async (req: extendedRequest, res: Response) => {
  try {
