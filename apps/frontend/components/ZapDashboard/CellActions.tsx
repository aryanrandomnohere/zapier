...
import {
  ...
  leftbarIsOpenAtom,
  selectedNotesAtom,
} from "@/RecoilState/store/leftbarAtom";
import dynamic from "next/dynamic";
import toast from "react-hot-toast";
const ToastNotification = dynamic(() => import("@/ui/Notification"), {
  ssr: false,
});
export default function CellActions({
  ...
  const setExpandedStep = useSetRecoilState(extendedStepNotesAtom);
        ...
        onClick={async () => {
          if (copiedItem) {
            try {
              ...
              console.error("Paste to replace error:", err);
              toast.custom((t) => (
                <ToastNotification
                  t={t}
                  type="error"
