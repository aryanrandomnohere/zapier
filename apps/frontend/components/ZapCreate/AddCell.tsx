  ...
  return (
    <div className="flex flex-col gap-1 items-center justify-center h-25">
      ...
      <div onClick={() => handleClick(index)}>
        <Plus className="text-blue-600 hover:text-white from-5% hover:bg-blue-600 rounded-full transform transition-all duration-300 p-0.5 text-xl hover:cursor-pointer" />
      </div>
