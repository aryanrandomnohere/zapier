...
export default function ZapCell({
  ...
  return (
    <div className="flex flex-col gap-0 zap-cell" onClick={()=>SelectCell(order-1)}>
      <div 
      ...
      >
        ...
        <div className="flex justify-between gap-2 items-center px-1.5 py-[1px] w-fit border border-black/20 bg-stone-200 rounded-md">
         { imagePath ? <img src={imagePath} alt="logo" className="w-5 h-5 rounded-full" /> : <BiSolidZap className="text-white p-0.5 bg-black  rounded-full" />}
